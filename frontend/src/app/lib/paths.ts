...
export interface paths {
    ...
    "/api/v1/rooms/invite_user_to_room": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Invite User To Room */
        post: operations["invite_user_to_room_api_v1_rooms_invite_user_to_room_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/rooms/invite_from_user_to_room": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Invite From User To Room */
        post: operations["invite_from_user_to_room_api_v1_rooms_invite_from_user_to_room_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/rooms/accept_room_invite": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Accept Room Invite */
        post: operations["accept_room_invite_api_v1_rooms_accept_room_invite_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/rooms/delete_room": {
        ...
        /** Delete Rooms */
        get: operations["delete_rooms_api_v1_rooms_delete_room_get"];
        put?: never;
        /** Delete Room By Id */
...
export interface components {
    schemas: {
        /** Body_invite_user_to_room_api_v1_rooms_invite_user_to_room_post */
        Body_invite_user_to_room_api_v1_rooms_invite_user_to_room_post: {
            notification_data: components["schemas"]["NotificationCreate"];
            invite_data: components["schemas"]["InviteCreateToRoom"];
        };
        /** HTTPValidationError */
        HTTPValidationError: {
            /** Detail */
        ...
        NotificationResponse: {
            ...
            /** Type */
            type: string;
            invitation: components["schemas"]["Invite"];
            /**
             * Created At
             * Format: date-time
             */
        ...
        /** SuccessResponse[List[InviteResponse]] */
        SuccessResponse_List_InviteResponse__: {
            /**
             * Status
             * @default 200
             */
...
export interface operations {
    ...
    invite_user_to_room_api_v1_rooms_invite_user_to_room_post: {
        parameters: {
            query: {
                user_code: string;
                inviter_id: string;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Body_invite_user_to_room_api_v1_rooms_invite_user_to_room_post"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    invite_from_user_to_room_api_v1_rooms_invite_from_user_to_room_post: {
        parameters: {
            query: {
                room_code: string;
                inviter_id: string;
    ...
    accept_room_invite_api_v1_rooms_accept_room_invite_post: {
        parameters: {
            query: {
                invite_id: string;
    ...
    delete_rooms_api_v1_rooms_delete_room_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_user_invitations_api_v1_invitations_get_user_invitations_post: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["SuccessResponse_List_InviteResponse__"];
                };
            };
            /** @description Validation Error */
            422: {
