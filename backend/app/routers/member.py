...
async def get_members(service: MemberService = Depends(get_member_service)):
...
async def add_member(member_data: MemberCreate, service: MemberService = Depends(get_member_service)):
...
async def update_member(member_id: str, member_data: MemberUpdate, service: MemberService = Depends(get_member_service)):
